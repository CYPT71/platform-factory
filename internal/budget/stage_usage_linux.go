...
// process has exited. Linux's getrusage(2) reports ru_maxrss in
// kilobytes, unlike Darwin's bytes - see stage_usage_darwin.go and
...
func FromProcessState(state *os.ProcessState) StageUsage {
	...
	return StageUsage{CPU: cpu, PeakRSS: rusage.Maxrss * 1024}
}
