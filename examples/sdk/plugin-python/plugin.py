#!/usr/bin/env python3
"""Reference platform-factory v1 language plugin, built on the secure_oci_plugin SDK.
...
# In a real deployment, install the SDK (`pip install platform-factory-plugin`)
