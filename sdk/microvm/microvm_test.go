...
func withName(spec Spec, value string) Spec { spec.Name = value; return spec }
func withMemory(spec Spec, value int) Spec  { spec.MemoryMiB = value; return spec }
func withVCPUs(spec Spec, value int) Spec   { spec.VCPUs = value; return spec }
func withPort(spec Spec, value int) Spec    { spec.Port = value; return spec }
