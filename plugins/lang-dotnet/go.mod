// This module depends on the main github.com/CYPT71/secure-oci-base
...
// dependencies.
module github.com/CYPT71/secure-oci-base/plugins/lang-dotnet

go 1.25.12

require github.com/CYPT71/secure-oci-base v0.0.2
